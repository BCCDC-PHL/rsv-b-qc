...
include { nextclade_dataset } from './modules/rsv-b-qc.nf'
...
include { plot_tree_snps } from './modules/rsv-b-qc.nf'
include { build_snpeff_db } from './modules/rsv-b-qc.nf'
include { snpeff } from './modules/rsv-b-qc.nf'
include { make_aa_table } from './modules/rsv-b-qc.nf'
include { primer_bed_to_amplicon_bed } from './modules/rsv-b-qc.nf'
include { calc_amplicon_depth } from './modules/rsv-b-qc.nf'
include { calc_per_base_depth } from './modules/rsv-b-qc.nf'
include { create_primer_snp_bed } from './modules/rsv-b-qc.nf'
include { make_genome_bed } from './modules/rsv-b-qc.nf'
include { make_sample_qc_summary } from './modules/rsv-b-qc.nf'
include { write_qc_summary } from './modules/rsv-b-qc.nf'
